...
const Index = () => {
  ...
  const plans = [
    {
      ...
      features: [
        ...
        '✓ Scanner de Kcal de alimentos com IA',
  ...
  const stats = [
    ...
    { value: 95, label: 'Taxa de Sucesso', suffix: '%', icon: Trophy },
    { value: 500, label: 'Treinos Disponíveis', suffix: '+', icon: Dumbbell },
    { value: 24, label: 'Suporte', suffix: '/7', icon: MessageCircle }
  ];
